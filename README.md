...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/yellow-butterfly-19c4#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-butterfly-19c4
```

A live public deployment of this template is available at [https://yellow-butterfly-19c4.templates.workers.dev](https://yellow-butterfly-19c4.templates.workers.dev)
